...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(action_dim=32, paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAlohaDataConfig(
            repo_id="robotwin/empty_cup_place",
            # base_config=DataConfig(prompt_from_task=True),
            default_prompt="Grab the cup and put it on the plate",
    ...
    TrainConfig(
        name="pi0_fast_robotwin_low_mem_finetune",
        # Here is an example of loading a pi0-FAST model for LoRA finetuning.
        # For setting action_dim, action_horizon, and max_token_len, see the comments above.
        model=pi0_fast.Pi0FASTConfig(
