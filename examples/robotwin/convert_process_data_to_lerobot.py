...
Script to convert  hdf5 data to the LeRobot dataset v2.0 format.
Example usage: python convert_aloha_data_to_lerobot.py --raw-dir ../processed_data --save_path ../final --repo-id empty_cup_place-aloha-agilex-1-m0_b0_l0_h0.0_c0_D435-2
author: james  
"""
...
def populate_dataset(
    ...
    for ep_idx in tqdm.tqdm(episodes):
        ...
        #     instruction = instruction_dict['instructions']    
...
def port_aloha(
    ...
    *,
    ...
    # dataset.consolidate() # video does  not need to process
