"""
Script to preprocess hdf5 data to standard format for lerobot dataset.
Example usage: python process.py empty_cup_place  aloha-agilex-1-m0_b0_l0_h0.0_c0_D435  100
author: james  
"""
import sys
import os
...
def data_transform(path, episode_num, save_path):
    ...
    for i in range(episode_num):
        ...
        instructions = "Grab the cup and put it on the plate"
...
if __name__ == "__main__":
    ...
    # import pdb
    # pdb.set_trace()
    load_dir = os.path.join("/home/ubuntu/workspace_clean/robotwin_data/data/", str(task_name), str(setting))

    begin = 0
    print(f'read data from path:{os.path.join(os.getcwd(), load_dir)}')
